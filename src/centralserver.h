...
/** @brief Tries really hard to connect to an app server.  Returns a connected file descriptor or -1 on error */
int connect_app_server();

/** @brief Helper function called by connect_app_server() to do the actual work including recursion - DO NOT CALL DIRECTLY */
