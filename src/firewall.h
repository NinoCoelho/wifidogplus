...
/** @brief Clears the appservers list, cjpthree@126.com 2015.5.13 */
void fw_clear_appservers(void);

/** @brief Sets the appservers list, cjpthree@126.com 2015.5.13 */
void fw_set_appservers(void);
...
char  *rarp_get(const char *req_mac);
char * arp_get_interface(const char *req_mac);


/** @brief Get an MAC's IP address from the ARP cache.*/
char *rarp_get(const char *req_mac);
