...
#define TABLE_WIFIDOG_APPSERVERS "WiFiDog_$ID$_AppServers"
#define TABLE_WIFIDOG_WHITE_URL "WiFiDog_$ID$_WhiteUrl"
...
#define TABLE_WIFIDOG_QOS_IN       "WiFiDog_$ID$_Qos_IN"
#define TABLE_WIFIDOG_QOS_OUT       "WiFiDog_$ID$_Qos_OUT"
...
/** @brief Exec a command via iptables*/
...
/** @brief Initializes the appservers table, cjpthree@126.com 2015.5.13 */
void iptables_fw_set_appservers(void);

/** @brief Clears the appservers table, cjpthree@126.com 2015.5.13 */
void iptables_fw_clear_appservers(void);
